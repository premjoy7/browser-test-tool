...
export default class AAMPPlayer {

    constructor(targetDiv = null) {
    ...
    load(url) {
        ...
        if (this.videoDiv !== null) {
            ...
            // //newVideoTag.className = "videoPlayer";
            // this.videoDiv.insertBefore(newVideoTag, this.videoDiv.childNodes[0]);
            //
            // let source = document.createElement('source');
            // source.src = "dummy.mp4";
            // source.mimeType = "video/ave";
            //
            // newVideoTag.appendChild(source);
            //
            // newVideoTag.width = 1080;
            // newVideoTag.height = 720;
        }
    }
